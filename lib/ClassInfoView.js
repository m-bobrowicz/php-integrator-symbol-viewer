...
module.exports = function ClassInfoView(classInfoModel) {
    ...
    filterInputContainer.style.width = '300px';
    filterInputContainer.classList.add('native-key-bindings');
    filterInputContainer.setAttribute('tabindex', -1);
    var filterInput = document.createElement('input');
    filterInput.classList.add('native-key-bindings');
    filterInputContainer.appendChild(filterInput);
    classInfoElement.appendChild(filterInputContainer);
    ...
    _.each(classInfoModel.staticProperties, (staticProperty) => {
        ...
        classInfoElement.appendChild(staticPropertieslist)
    });
