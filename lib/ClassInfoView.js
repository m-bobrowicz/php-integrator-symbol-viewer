...
module.exports = function ClassInfoView(classInfoModel) {
    ...
    var classInfoElementContainer = document.createElement('div');
    classInfoElementContainer.classList.add('php-integrator-symbol-viewer-container');
    classInfoElementContainer.appendChild(classInfoElement);
    return classInfoElementContainer;
}
